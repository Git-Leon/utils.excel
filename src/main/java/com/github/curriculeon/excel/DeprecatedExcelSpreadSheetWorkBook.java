 ...
 */
public class DeprecatedExcelSpreadSheetWorkBook implements Iterable<ExcelSpreadSheet> {
    private final Workbook workbook;
    private final File file;

    public DeprecatedExcelSpreadSheetWorkBook(String filePath) {
        this(new File(filePath));
    }

    public DeprecatedExcelSpreadSheetWorkBook(File file) {
        try {
            this.file = file;
    ...
    public DeprecatedExcelSpreadSheetWorkBook copyTo(File destination) {
        try {
            FileUtils.copyFile(file, destination);
            return new DeprecatedExcelSpreadSheetWorkBook(destination);
        } catch (IOException e) {
            throw new Error(e);
        }
    }
